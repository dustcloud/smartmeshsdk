...
class OAPDispatcher(object):
    """The OAP Dispatcher receives OAP packets, parses them and calls
    registered callbacks.

    The caller is responsible for ensuring that the dispatchers is subscribed to
    Data notifications with the dispatch_pkt callback.
