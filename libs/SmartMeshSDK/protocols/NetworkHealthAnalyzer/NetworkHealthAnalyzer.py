...
class NetworkHealthAnalyzer(object):
    ...
    def _nettest_networkAvailability(self,data):
        ...
        <p>
            The network availability is the portion of the packets generated by the motes' apps, which were 
    ...
    def _nettest_networkReliability(self,data):
        '''
        <p>
            This test verifies that the overall network reliability is above MIN_NETWORKRELIABILITY threshold.
        </p>
        <p>
    ...
    def _nettest_multipleJoins(self,data):
        '''
        <p>
            This test verifies that each mote has joined the same number of times as AP.
        </p>
        <p>
    ...
    def _nettest_insufficientBandwidth(self,data):
        '''
        <p>
            This test verifies that the total bandwidth needed is more than the assigned bandwidth
        </p>
        <p>
            The manager keeps track of the requested and assigned bandwidth for each mote. Check to make sure that totalNeededBw > assignedBW.
        </p>
        <p>
            This test is run once for all motes in the network.
        </p>
        '''
        ...
        for (mac,moteinfo) in data['moteinfo'].items():        
            ...
            if moteinfo['totalNeededBw']>moteinfo['assignedBw']:
                descPASS += [
                    'Total needed bandwidth for mote {0} is {1} ms, which is more than assigned bandwidth {2} ms. \n'.format(
                        FormatUtils.formatMacString(mac),
    ...
    def _nettest_perMoteAvailability(self,data):
        ...
        <p>
            The mote availability is the portion of the packets generated by the mote's application which were 
    ...
    def _nettest_moteCongestion(self,data):
        ...
        '''   
        <p>
            This test verifies if there is congestion at a mote
        </p>
        <p>
            ...
            are in danger of seeing congestion at some point. Motes that have a maximum queue length of 4 or more 
            may have experienced acute congestion during the interval. Finally, congested motes typically have higher 
            latency than their peers. 
        </p>
        <p>
            This test is run once for each mote in the network.
        </p>
    ...
    def _nettest_stabilityVsRssi(self,data):
        '''
        <p>
            This test verifies that stability of a path is plausible given its RSSI.
        </p>
        <p>
            In the absence of heavy interference, the is a straightforward relationship between the RSSI and stability of a path:
            <ul>
        ...
        <p>
            This test is run once for each path in the network over which at least THRES_NUM_PACKETS packet have been transmitted.
        </p>
        '''
